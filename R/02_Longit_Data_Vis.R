...
# read 2018-19 data ------------------------------------------------------------------
IAPT_18_19_raw <- read_csv(here::here("Data","Raw_Annual_Data","psych-ther-ann-rep-csv-2018-19-main-csv.csv"), na = c("*", "", "NULL", "-"))
...
## @knitr combine-longitudinal-data
...
## @knitr long-depriv-plot-recovery
line_fun(Long_Depriv_England, "PercentageRecovery", "Percentage of treated per decile achieving recovery", "Percentage")   
